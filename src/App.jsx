...
import {
  ...
  listVma, listEvents, listMessages, listWellness, listJours,
} from "./lib/db";
...
export default function App() {
  ...
  const reload = useCallback(async () => {
    const [sw, se, pr, jo, pe, vm, ev, ms, we] = await Promise.all([
      listSwimmers(), listSessions(), listPresences(), listJours(), listPerformances(),
  ...
  return (
    <div className="app">
      ...
      {view === "seances" && <Seances swimmers={swimmers} sessions={sessions} presences={presences} jours={jours} readOnly={readOnly} mySwimmerId={profile.swimmer_id} reload={reload} />}
