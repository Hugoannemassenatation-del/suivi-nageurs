...
import {
  ...
  MessageSquare, ShieldCheck, LogOut, ClipboardList, BarChart3, Menu, X, Award, HeartPulse,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { id: "sante", label: "Santé", icon: HeartPulse, roles: ["coach", "admin", "famille"] },
...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      {view === "presences" && <Presences swimmers={swimmers} presences={presences} jours={jours} jourRpes={jourRpes} staffName={profile.nom} reload={reload} />}
      {view === "statistiques" && <Statistiques swimmers={swimmers} sessions={sessions} presences={presences} jours={jours} jourRpes={jourRpes} />}
      {view === "sante" && <Sante swimmers={swimmers} isStaff={role === "coach" || role === "admin"} mySwimmerId={profile.swimmer_id} mySession={session} />}
