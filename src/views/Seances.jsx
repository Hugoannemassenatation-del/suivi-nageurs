        ...
        {recent.map((j) => {
          ...
          return (
            <div key={j.id} className="row-line" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <span><span className="strong">{j.date}</span>{j.heure ? ` · ${j.heure}` : ""}{j.label ? ` — ${j.label}` : ""}</span>
          ...
          return (
            <div key={j.id} className="row-line" style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span><span className="strong">{j.date}</span>{j.heure ? ` · ${j.heure}` : ""}{j.label ? ` — ${j.label}` : ""}{j.groupe ? ` (${j.groupe})` : ""}</span>
