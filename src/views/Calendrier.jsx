...
import { TYPES_EVENT, todayISO, daysAgo, monthLabel, addMonths, toISODate, buildMonthGrid, JOURS_FR } from "../lib/format";
import {
...
export default function Calendrier({ events, swimmers, readOnly, isStaff, reload }) {
  ...
  return (
    <div className="view">
      ...
      {selectedDay && (
        <Modal title={selectedDay.iso} onClose={() => setSelectedDay(null)}>
