...
import { METHODES_VMA, POURCENTAGES_VMA, RPE_ECHELLE, todayISO, formatSeconds, paceFor100, formatDateFR } from "../lib/format";
            ...
            {currentVma && (
              <>
                <div className="vma-summary">
                  Dernier test : <span className="strong">{currentVma.valeur} m/min</span> — {currentVma.methode} du {formatDateFR(currentVma.date)}
                </div>
