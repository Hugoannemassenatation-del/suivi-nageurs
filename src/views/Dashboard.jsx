...
import { daysAgo, formatDateFR } from "../lib/format";
          ...
          {lastSession ? (
            <div>
              <div className="session-card-top">
                ...
                <span className="session-date">{formatDateFR(lastSession.date)}</span>
              </div>
          ...
          {nextEvent ? (
            <div>
              <div className="session-card-top">
                ...
                <span className="session-date">{formatDateFR(nextEvent.date_debut)}{nextEvent.date_fin ? ` → ${formatDateFR(nextEvent.date_fin)}` : ""}</span>
              </div>
